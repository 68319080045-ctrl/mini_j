...
<head>
    ...
    <title>Raven Tone Register | Bootstrap 5</title>
...
<body>
    ...
    <div class="login-card">
        <h2 class="text-center mb-4 fw-bold">ลงทะเบียนสมาชิก</h2>
        <form action="save_register.php" method="post">
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="registerUsername" name="username"
                    placeholder="name@example.com" required>
                <label for="registerUsername">อีเมล หรือ ชื่อผู้ใช้</label>
            </div>
            ...
            <p class="text-center text-secondary mt-3" style="font-size: 0.9rem;">
                มีบัญชีอยู่แล้ว? <a href="login.php" class="text-decoration-none fw-bold"
                    style="color: #9c27b0;">เข้าสู่ระบบที่นี่</a>
            </p>
        </form>
    </div>
